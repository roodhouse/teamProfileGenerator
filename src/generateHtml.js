...
<body>
    ...
    <div id="theTeam" class="container-fluid col-sm-8">
        ...
        <div id="engineer" class="row">
            <div class="col-12 bg-danger">
                <h3 id="engineerName">Name <i class="fa-solid fa-cloud"></i></h3>
                <p>ID: <span id="engineerId"></span></p>
                <p>Email: <span id="engineerEmail"></span></p>
                <p>GitHub: <span id="engineerGit"></span></p>
            </div>
        </div>

        <div id="intern" class="row">
            <div class="col-12 bg-danger">
                <h3 id="internName">Name <i class="fa-solid fa-cloud"></i></h3>
                <p>ID: <span id="internId"></span></p>
                <p>Email: <span id="internEmail"></span></p>
                <p>School: <span id="internSchool"></span></p>
            </div>
        </div>
